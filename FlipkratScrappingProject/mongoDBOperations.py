...
class MongoDBManagement:
    ...
    def __init__(self, username, password):
        ...
        try:
            ...
            #self.url = "mongodb+srv://ineuron:ineuron@cluster0.smtjq.mongodb.net/myFirstDatabase?retryWrites=true&w=majority".format(
                #self.username, self.password)
            self.url = "mongodb+srv://ineuron:ineuron@cluster0.smtjq.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"
